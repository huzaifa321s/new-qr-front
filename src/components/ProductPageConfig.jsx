    ...
    return (
        <div>
            ...
            <motion.div style={{ background: '#0f172a', borderRadius: '12px', border: '1px solid #1e293b', marginBottom: '1.5rem', overflow: 'hidden' }}>
                ...
                >
                    <div>
                        <div style={{ fontWeight: 'bold', color: '#e2e8f0', fontSize: '1rem', textTransform: 'uppercase' }}>BASIC INFORMATION</div>
                    </div>
                    ...
                    {isBasicInfoOpen && (
                        ...
                        >
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 0.5fr', gap: '1rem', marginBottom: '1.5rem', alignItems: 'end' }}>
                                <div>
                                    ...
                                    <input
                                        ...
                                        style={{
                                            ...
                                            padding: '0.75rem',
                                            borderRadius: '4px',
                                            border: errors.companyName ? '1px solid #ef4444' : '1px solid #334155',
                                            fontSize: '0.9rem',
                                            outline: 'none',
                                            color: '#e2e8f0',
                                            background: '#020617'
                                ...
                                <div>
                                    <label style={{ display: 'block', fontSize: '0.7rem', color: '#94a3b8', marginBottom: '0.5rem' }}>Text Color</label>
                                    <div style={{ display: 'flex', alignItems: 'center', border: '1px solid #334155', borderRadius: '4px', padding: '0.5rem', height: '42px', background: '#020617' }}>
                                        <input
                                            type="text"
                                            value={basicInfo.companyTextColor || '#000000'}
                                            onChange={(e) => handleBasicInfoUpdate('companyTextColor', e.target.value)}
                                            style={{ border: 'none', outline: 'none', width: '100%', fontSize: '0.85rem', fontWeight: 'bold', background: 'transparent', color: '#e2e8f0' }}
                                        />
                                        <div style={{ width: '24px', height: '24px', borderRadius: '2px', overflow: 'hidden', position: 'relative', border: '1px solid #475569' }}>
                                            <input
                                                type="color"
                                                value={basicInfo.companyTextColor || '#000000'}
                                                onChange={(e) => handleBasicInfoUpdate('companyTextColor', e.target.value)}
                                ...
                                <div>
                                    <label style={{ display: 'block', fontSize: '0.7rem', color: '#94a3b8', marginBottom: '0.5rem' }}>Font</label>
                                    <select
                                        value={basicInfo.companyFont || 'Lato'}
                                        onChange={(e) => handleBasicInfoUpdate('companyFont', e.target.value)}
                                        style={{ width: '100%', height: '42px', borderRadius: '4px', border: '1px solid #334155', padding: '0 0.5rem', outline: 'none', fontSize: '0.85rem', background: '#020617', color: '#e2e8f0' }}
                                    >
                            ...
                            <div style={{ marginBottom: '2rem' }}>
                                ...
                                <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                                    {(basicInfo.productImages || defaultProductImages).map(img => (
                                        <div key={img.id} style={{ width: '60px', height: '60px', borderRadius: '4px', border: '1px solid #334155', padding: '4px', position: 'relative', background: '#020617' }}>
                                    ...
                                    <div
                                        ...
                                        style={{
                                            width: '60px', height: '60px', borderRadius: '4px', border: '1px dashed #334155', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', background: '#020617'
                                        }}
                                    >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        style={{
                                            ...
                                            padding: '0.75rem',
                                            borderRadius: '4px',
                                            border: errors.productTitle ? '1px solid #ef4444' : '1px solid #334155',
                                            fontSize: '0.9rem',
                                            outline: 'none',
                                            color: '#e2e8f0',
                                            background: '#020617'
                            ...
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <input
                                    ...
                                    placeholder="325 ml"
                                    style={{ width: '100%', padding: '0.75rem', borderRadius: '4px', border: '1px solid #334155', fontSize: '0.9rem', outline: 'none', color: '#e2e8f0', background: '#020617' }}
                                />
                            </div>
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        style={{
                                            ...
                                            height: '42px',
                                            borderRadius: '4px',
                                            border: errors.currency ? '1px solid #ef4444' : '1px solid #334155',
                                            padding: '0 0.5rem',
                                            outline: 'none',
                                            fontSize: '0.9rem',
                                            color: '#e2e8f0',
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        style={{
                                            ...
                                            padding: '0.75rem',
                                            borderRadius: '4px',
                                            border: errors.price ? '1px solid #ef4444' : '1px solid #334155',
                                            fontSize: '0.9rem',
                                            outline: 'none',
                                            color: '#e2e8f0',
                                            background: '#020617'
            ...
            <motion.div style={{ background: '#0f172a', borderRadius: '12px', border: '1px solid #1e293b', marginBottom: '1.5rem', overflow: 'hidden' }}>
                <motion.div
                    ...
                    style={{
                        ...
                        justifyContent: 'space-between',
                        cursor: 'pointer',
                        borderBottom: isContentOpen ? '1px solid #1e293b' : 'none'
                    }}
                >
                    <div>
                        <div style={{ fontWeight: 'bold', color: '#e2e8f0', fontSize: '1rem', textTransform: 'uppercase' }}>CONTENT</div>
                    </div>
                    {isContentOpen ? <ChevronUp size={20} color="#94a3b8" /> : <ChevronDown size={20} color="#94a3b8" />}
                </motion.div>
                        ...
                        >
                            ...
                            {(contentItems || []).map((item, index) => (
                                <div key={item.id} style={{ marginBottom: '2rem' }}>
                                    ...
                                    <div style={{ marginBottom: '1rem' }}>
                                        ...
                                        <input
                                            ...
                                            style={{
                                                ...
                                                padding: '0.75rem',
                                                borderRadius: '4px',
                                                border: errors.content?.[item.id] ? '1px solid #ef4444' : '1px solid #334155',
                                                fontSize: '0.9rem',
                                                outline: 'none',
                                                color: '#e2e8f0',
                                                background: '#020617'
                                    ...
                                    {/* React Quill Editor */}
                                    <div style={{ border: '1px solid #334155', borderRadius: '4px', overflow: 'hidden', background: '#fff' }} className="quill-editor-container">
                                        <style>
                                            {`
                            ...
                            <div style={{ marginBottom: '2rem' }}>
                                ...
                                <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                                    {(content.certificates || [
                                        ...
                                        <div key={cert.id} style={{ width: '60px', height: '60px', borderRadius: '4px', border: '1px solid #334155', padding: '4px', position: 'relative', background: '#020617' }}>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        style={{
                                            ...
                                            padding: '0.75rem',
                                            borderRadius: '4px',
                                            border: errors.buttonText ? '1px solid #ef4444' : '1px solid #334155',
                                            fontSize: '0.9rem',
                                            outline: 'none',
                                            color: '#e2e8f0',
                                            background: '#020617'
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        style={{
                                            ...
                                            padding: '0.75rem',
                                            borderRadius: '4px',
                                            border: errors.buttonLink ? '1px solid #ef4444' : '1px solid #334155',
                                            fontSize: '0.9rem',
                                            outline: 'none',
                                            color: '#e2e8f0',
                                            background: '#020617'
            ...
            <motion.div style={{ background: '#0f172a', borderRadius: '12px', border: '1px solid #1e293b', marginBottom: '1.5rem', overflow: 'hidden' }}>
                <motion.div
                    ...
                    style={{
                        ...
                        justifyContent: 'space-between',
                        cursor: 'pointer',
                        borderBottom: isVideoOpen ? '1px solid #1e293b' : 'none'
                    }}
                >
                    <div>
                        <div style={{ fontWeight: 'bold', color: '#e2e8f0', fontSize: '1rem', textTransform: 'uppercase' }}>VIDEO</div>
                    </div>
                    {isVideoOpen ? <ChevronUp size={20} color="#94a3b8" /> : <ChevronDown size={20} color="#94a3b8" />}
                </motion.div>
                            ...
                            <div style={{ marginBottom: '1.5rem' }}>
                                ...
                                <input
                                    ...
                                    style={{
                                        ...
                                        padding: '0.75rem',
                                        borderRadius: '4px',
                                        border: errors.videoTitle ? '1px solid #ef4444' : '1px solid #334155',
                                        fontSize: '0.9rem',
                                        outline: 'none',
                                        color: '#e2e8f0',
                                        background: '#020617'
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    style={{
                                        ...
                                        padding: '0.75rem',
                                        borderRadius: '4px',
                                        border: errors.videoUrl ? '1px solid #ef4444' : '1px solid #334155',
                                        fontSize: '0.9rem',
                                        outline: 'none',
                                        color: '#e2e8f0',
                                        background: '#020617',
                                ...
                                <div style={{ textAlign: 'right', fontSize: '0.7rem', color: '#94a3b8', marginTop: '0.5rem' }}>
                                    10MB max Video size
                                </div>
                            </div>
            ...
            <motion.div style={{ background: '#0f172a', borderRadius: '12px', border: '1px solid #1e293b', marginBottom: '1.5rem', overflow: 'hidden' }}>
                <motion.div
                    ...
                    style={{
                        ...
                        justifyContent: 'space-between',
                        cursor: 'pointer',
                        borderBottom: isFeedbackOpen ? '1px solid #1e293b' : 'none'
                    }}
                >
                    <div>
                        <div style={{ fontWeight: 'bold', color: '#e2e8f0', fontSize: '1rem', textTransform: 'uppercase' }}>FEEDBACK/RATING</div>
                    </div>
                    {isFeedbackOpen ? <ChevronUp size={20} color="#94a3b8" /> : <ChevronDown size={20} color="#94a3b8" />}
                </motion.div>
                                    ...
                                    <div style={{ flex: '2 1 200px' }}>
                                        ...
                                        <input
                                            ...
                                            style={{
                                                ...
                                                padding: '0.75rem',
                                                borderRadius: '4px',
                                                border: errors.feedbackTitle ? '1px solid #ef4444' : '1px solid #334155',
                                                fontSize: '0.9rem',
                                                outline: 'none',
                                                color: '#e2e8f0',
                                                background: '#020617'
                                ...
                                <div style={{ flex: '1 1 120px' }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', border: '1px solid #334155', borderRadius: '4px', padding: '0.5rem', height: '42px', background: '#020617' }}>
                                        <input
                                            ...
                                            style={{ border: 'none', outline: 'none', width: '100%', fontSize: '0.85rem', fontWeight: 'bold', background: 'transparent', color: '#e2e8f0' }}
                                        />
                                        <div style={{ width: '24px', height: '24px', border: '1px solid #475569', borderRadius: '2px', overflow: 'hidden', position: 'relative', flexShrink: 0 }}>
                                            <input
                                                type="color"
                                                value={feedback.textColor || '#ffffff'}
                                                onChange={(e) => handleFeedbackUpdate('textColor', e.target.value)}
            ...
            <motion.div style={{ background: '#0f172a', borderRadius: '12px', border: '1px solid #1e293b', marginBottom: '1.5rem', overflow: 'hidden' }}>
                ...
                >
                    <div>
                        <div style={{ fontWeight: 'bold', color: '#e2e8f0', fontSize: '1rem', textTransform: 'uppercase' }}>CONTACT</div>
                        ...
                        >
                            ...
                            {contact.phone != null ? (
                                <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
                                    <div style={{ width: '42px', height: '42px', border: '1px solid #334155', borderRadius: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, background: '#020617' }}>
                                        <Phone size={20} color="#94a3b8" />
                                    </div>
                                    <div style={{ flex: '1 1 200px', position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', display: 'flex', alignItems: 'center', gap: '4px', color: '#94a3b8' }}>
                                            <Globe size={14} />
                                        </div>
                                        <input
                                            type="text"
                                            ...
                                            style={{
                                                ...
                                                borderRadius: '4px',
                                                border: errors.contact?.phone ? '1px solid #ef4444' : '1px solid #334155',
                                                fontSize: '0.9rem',
                                                outline: 'none',
                                                color: '#e2e8f0',
                                                background: '#020617'
                                ...
                                <div style={{ marginBottom: '1rem' }}>
                                    <button
                                        ...
                                        style={{
                                            display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem 1rem', border: '1px solid #ffa305', borderRadius: '4px', color: '#ffa305', background: '#020617', fontSize: '0.8rem', fontWeight: 'bold', cursor: 'pointer'
                                        }}
                                    >
                            ...
                            {contact.email != null ? (
                                <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', alignItems: 'center' }}>
                                    <div style={{ width: '42px', height: '42px', border: '1px solid #334155', borderRadius: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#020617' }}>
                                    ...
                                    <div style={{ flex: 1 }}>
                                        <input
                                            ...
                                            style={{
                                                ...
                                                padding: '0.75rem',
                                                borderRadius: '4px',
                                                border: errors.contact?.email ? '1px solid #ef4444' : '1px solid #334155',
                                                fontSize: '0.9rem',
                                                outline: 'none',
                                                color: '#e2e8f0',
                                                background: '#020617'
                                    ...
                                    <div style={{ flex: 1 }}>
                                        <input
                                            ...
                                            style={{
                                                ...
                                                padding: '0.75rem',
                                                borderRadius: '4px',
                                                border: errors.contact?.website ? '1px solid #ef4444' : '1px solid #334155',
                                                fontSize: '0.9rem',
                                                outline: 'none',
                                                color: '#e2e8f0',
                                                background: '#020617'
                                    ...
                                    return (
                                        <div key={idx} style={{ position: 'relative' }}>
                                            ...
                                            <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                                                <div style={{ flex: 1, position: 'relative', display: 'flex', alignItems: 'center', border: errors.contact?.[`social_${social.platform}`] ? '1px solid #ef4444' : '1px solid #334155', borderRadius: '4px', overflow: 'hidden', paddingLeft: '0.5rem', background: '#020617' }}>
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="https://"
                                                        style={{ width: '100%', height: '42px', border: 'none', outline: 'none', padding: '0 0.5rem', fontSize: '0.9rem', color: '#e2e8f0', background: 'transparent' }}
                                                    />
                                                </div>
            ...
            <motion.div style={{ background: '#0f172a', borderRadius: '12px', border: '1px solid #1e293b', marginBottom: '1.5rem', overflow: 'hidden' }}>
                <motion.div
                    ...
                    style={{
                        ...
                        justifyContent: 'space-between',
                        cursor: 'pointer',
                        borderBottom: isShareOpen ? '1px solid #1e293b' : 'none'
                    }}
                >
                    <div>
                        <div style={{ fontWeight: 'bold', color: '#e2e8f0', fontSize: '1rem', textTransform: 'uppercase' }}>SHARE</div>
                    </div>
                    {isShareOpen ? <ChevronUp size={20} color="#94a3b8" /> : <ChevronDown size={20} color="#94a3b8" />}
                </motion.div>
